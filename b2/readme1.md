...
| **사용 도구 및 목적** | 이미지: **제미나이 바나나** (`--sref`로 씬2 톤 유지) / 비디오: **Runway** (부드러운 패닝) / 오디오: **Suno** (희망적 마무리) + **ElevenLabs TTS** / 로고: **CapCut** |
...
## 5-1. 프롬프트 수정 전/후 기록 (씬 1)

| 항목 | 내용 |
|------|------|
| **수정 전 의도** | 이끼 낀 숲속 그루터기
| **문제 ①** | 배경 초록색이 과해 제품이 묻히고, 인공 조명이 브랜드 톤(자연광·미니멀)과 불일치 |
| **문제 ②** | 주제를 부각하기 위한 문제 인식 장면으로 부적합 |
| **수정 후 변경** | 제품 단독 컷 → **오염된 바다**으로 전면 변경. 문제 인식을 시각적으로 구체화  |
| **결과 변화** | 거북이의 눈과 바닷가 영상으로 텀블러를 반드시 사용해야 하겠다는 생각을  가지게 함 |


----

## 5-2. 프롬프트 수정 전/후 기록 (씬 2)
